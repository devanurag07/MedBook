...
class Queue extends Component {
     ...
     */
    getCustomerLookup() {
        getCall(BASE_URL + `api/users/get-customers/`).then(r => {
            this.setState(state => ({
    ...
    addCustomerHandler = (event, values) => {
        ...
        postCall(BASE_URL + `api/users/`, values).then(r => {
            ...
            <React.Fragment>
                <div className="row mt-2 p-3">
                    <div className="col">
                        ...
                        <SmartTable colFilter={true} ref={instance => { this.smartTable = instance; }} fetchUrl="api/queue/" dataItem={this.props.category} actionHandler={this.actionHandler} recordPerPage={this.recordPerPage} cols={this.state.columns} />
                ...
                <Modal isOpen={this.state.isModalOpen} size="lg" toggle={this.toggle}>
                    <AvForm onValidSubmit={this.submitHandler} model={this.state.formValues}>
                        <ModalHeader toggle={this.toggle}>{this.state.formValues.id ? 'Edit Queue' : 'Add Queue'}</ModalHeader>
                        <ModalBody>
                            <div className="row">
                ...
                <Modal isOpen={this.state.isCustomerModalOpen} toggle={this.showCustomerToggle}>
                    <AvForm onValidSubmit={this.addCustomerHandler} model={this.state.customerFormValues}>
                        <ModalHeader toggle={this.showCustomerToggle}>Add Customer</ModalHeader>
                        <ModalBody>
                            <div className="row">
                                <div className="col-lg-12">
                                    <div className="form-group">
                                ...
                                <div className="col-lg-12">
                                    <div className="form-group">
                                        <AvInput bsSize="sm" type="text" onChange={this.inputChangedHandler.bind(this)} name="email" className="form-control sm" placeholder="Please enter the email" />
                                        {this.state.emailExist && <p className="text-danger">Email already exist</p>}
                                    </div>
                                </div>
                                <div className="col-lg-12">
                                    <div className="form-group">
                                        <AvInput bsSize="sm" type="text" name="mobile" required validate={{ pattern: { value: /^\d{10}$/ } }} className="form-control sm" required placeholder="Please enter the mobile" />
                                    </div>
                                </div>
                                <div className="col-lg-12">
                                    <div className="form-group">
                        ...
                        <ModalFooter>
                            <Button color="secondary" onClick={this.showCustomerToggle}>Close</Button>
